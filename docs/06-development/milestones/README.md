...
Android 老人端和家属端基础 UI 已完成。当前已跨里程碑实现文字流式聊天、长期记忆基础、天气/电话/家属报告 Tool、家庭通知与提醒、模型配置与用量、以及 mock 图像驱动的独立状态监控 Agent。ASR/TTS、本地提醒调度、结构化记忆治理、通用 Policy/任务状态机、GUI Agent、网购外卖、本地音乐和 SOS 仍待开发。逐项状态以 [`../../08-roadmap/todo.md`](../../08-roadmap/todo.md) 为准。
